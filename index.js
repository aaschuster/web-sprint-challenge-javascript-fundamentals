...
/* The nested function can access the "internal" variable because it is inside of the scope of myFunction() where the "internal" variable lives. It is possible to access variables and functions that are in a larger scope but not a smaller one. In other words it is possible to access functions and variables that are closer to the global scope but not ones that are in a scope further from the global scope. */
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    ...
    array.forEach(function(current) {
      displayNames.push("name: " + current.animal_name + ", scientific: " + current.scientific_name);
    });
    return displayNames;
  }
  ...
  */
  ...
  function lowerCaseNames(array){
    return array.map(function(current) {
      return current.animal_name.toLowerCase();
    });
  }
  ...
  */
  ...
  function USApop(array){
    return array.reduce(function(accumulator, current) {return accumulator + current.population}, 0);
  }
